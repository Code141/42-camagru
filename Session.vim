...
setlocal fen
silent! normal! zE
let s:l = 82 - ((70 * winheight(0) + 40) / 80)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
82
...
setlocal fen
silent! normal! zE
let s:l = 59 - ((31 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
59
...
setlocal fen
silent! normal! zE
let s:l = 52 - ((20 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
52
...
setlocal fen
silent! normal! zE
let s:l = 57 - ((35 * winheight(0) + 34) / 69)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
57
...
setlocal fen
silent! normal! zE
let s:l = 51 - ((27 * winheight(0) + 40) / 80)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
51
