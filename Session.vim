...
badd +67 app/controllers/login.php
...
badd +0 app/views/prompter.html
badd +1 app/script/php
argglobal
silent! argdel *
...
setlocal fen
silent! normal! zE
let s:l = 119 - ((6 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
119
...
setlocal fen
silent! normal! zE
let s:l = 137 - ((58 * winheight(0) + 40) / 80)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
137
...
setlocal fen
silent! normal! zE
let s:l = 49 - ((21 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
49
...
setlocal fen
silent! normal! zE
let s:l = 31 - ((27 * winheight(0) + 40) / 80)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
31
...
setlocal fen
silent! normal! zE
let s:l = 103 - ((23 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
103
...
setlocal fen
silent! normal! zE
let s:l = 25 - ((17 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
25
