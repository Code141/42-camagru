...
badd +0 app/views/gallery/focus.html
badd +0 app/assets/css/focus.css
argglobal
silent! argdel *
...
setlocal fen
silent! normal! zE
let s:l = 76 - ((42 * winheight(0) + 40) / 80)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
76
...
setlocal fen
silent! normal! zE
let s:l = 77 - ((71 * winheight(0) + 40) / 80)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
77
...
setlocal fen
silent! normal! zE
let s:l = 25 - ((12 * winheight(0) + 7) / 15)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
25
...
setlocal fen
silent! normal! zE
let s:l = 146 - ((22 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
146
...
setlocal fen
silent! normal! zE
let s:l = 44 - ((14 * winheight(0) + 24) / 48)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
44
...
setlocal fen
silent! normal! zE
let s:l = 48 - ((45 * winheight(0) + 29) / 59)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
48
...
setlocal fen
silent! normal! zE
let s:l = 77 - ((25 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
77
...
setlocal fen
silent! normal! zE
let s:l = 42 - ((30 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
42
...
setlocal fen
silent! normal! zE
let s:l = 100 - ((36 * winheight(0) + 22) / 44)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
100
...
setlocal fen
silent! normal! zE
let s:l = 14 - ((12 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
14
...
setlocal fen
silent! normal! zE
let s:l = 61 - ((35 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
61
...
setlocal fen
silent! normal! zE
let s:l = 36 - ((14 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
36
...
setlocal fen
silent! normal! zE
let s:l = 98 - ((24 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
98
...
setlocal fen
silent! normal! zE
let s:l = 21 - ((7 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
21
...
setlocal fen
silent! normal! zE
let s:l = 61 - ((42 * winheight(0) + 31) / 62)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
61
...
setlocal fen
silent! normal! zE
let s:l = 24 - ((9 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
24
...
setlocal fen
silent! normal! zE
let s:l = 230 - ((24 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
230
...
setlocal fen
silent! normal! zE
let s:l = 109 - ((7 * winheight(0) + 7) / 14)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
109
...
setlocal fen
silent! normal! zE
let s:l = 47 - ((9 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
47
