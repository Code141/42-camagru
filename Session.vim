...
badd +1 app/views/editor/upload_file.php
...
setlocal fen
silent! normal! zE
let s:l = 60 - ((48 * winheight(0) + 36) / 72)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
60
...
setlocal fen
silent! normal! zE
let s:l = 86 - ((79 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
86
...
setlocal fen
silent! normal! zE
let s:l = 95 - ((33 * winheight(0) + 34) / 69)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
95
...
setlocal fen
silent! normal! zE
let s:l = 40 - ((26 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
40
...
setlocal fen
silent! normal! zE
let s:l = 136 - ((7 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
136
...
setlocal fen
silent! normal! zE
let s:l = 95 - ((13 * winheight(0) + 28) / 57)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
95
