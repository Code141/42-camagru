...
badd +17 app/script/js/lunch.js
badd +1 .htaccess
...
badd +0 app/views/gallery/focus_right.php
argglobal
silent! argdel *
...
setlocal fen
silent! normal! zE
let s:l = 21 - ((15 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
21
...
setlocal fen
silent! normal! zE
let s:l = 140 - ((6 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
140
...
setlocal fen
silent! normal! zE
let s:l = 32 - ((26 * winheight(0) + 20) / 41)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
32
...
setlocal fen
silent! normal! zE
let s:l = 51 - ((23 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
51
...
setlocal fen
silent! normal! zE
let s:l = 78 - ((72 * winheight(0) + 40) / 80)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
78
...
setlocal fen
silent! normal! zE
let s:l = 123 - ((35 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
123
...
wincmd t
set winminheight=1 winheight=1 winminwidth=1 winwidth=1
exe '1resize ' . ((&lines * 11 + 42) / 84)
exe 'vert 1resize ' . ((&columns * 84 + 182) / 364)
exe '2resize ' . ((&lines * 46 + 42) / 84)
exe 'vert 2resize ' . ((&columns * 84 + 182) / 364)
exe '3resize ' . ((&lines * 21 + 42) / 84)
exe 'vert 3resize ' . ((&columns * 84 + 182) / 364)
exe 'vert 4resize ' . ((&columns * 95 + 182) / 364)
exe '5resize ' . ((&lines * 64 + 42) / 84)
exe 'vert 5resize ' . ((&columns * 98 + 182) / 364)
exe '6resize ' . ((&lines * 15 + 42) / 84)
exe 'vert 6resize ' . ((&columns * 98 + 182) / 364)
exe '7resize ' . ((&lines * 20 + 42) / 84)
exe 'vert 7resize ' . ((&columns * 84 + 182) / 364)
exe '8resize ' . ((&lines * 59 + 42) / 84)
...
setlocal fen
silent! normal! zE
let s:l = 75 - ((7 * winheight(0) + 10) / 21)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
75
...
setlocal fen
silent! normal! zE
let s:l = 95 - ((40 * winheight(0) + 32) / 64)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
95
...
setlocal fen
silent! normal! zE
let s:l = 20 - ((9 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
20
...
setlocal fen
silent! normal! zE
let s:l = 68 - ((14 * winheight(0) + 29) / 59)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
68
...
setlocal fen
silent! normal! zE
let s:l = 49 - ((45 * winheight(0) + 27) / 55)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
49
...
setlocal fen
silent! normal! zE
let s:l = 318 - ((14 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
318
...
setlocal fen
silent! normal! zE
let s:l = 55 - ((52 * winheight(0) + 29) / 59)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
55
...
setlocal fen
silent! normal! zE
let s:l = 103 - ((20 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
103
...
setlocal fen
silent! normal! zE
let s:l = 31 - ((30 * winheight(0) + 8) / 16)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
31
...
setlocal fen
silent! normal! zE
let s:l = 34 - ((26 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
34
...
setlocal fen
silent! normal! zE
let s:l = 31 - ((14 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
31
